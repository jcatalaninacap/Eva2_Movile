 ...
 */
    private String fecha; // Fecha de la entrada de log
    private String mensaje; // Mensaje descriptivo de la entrada de log
    private String accion; // Acción realizada, añadido como un campo adicional
    ...
    public LogDTO(String fecha, String mensaje, String accion) {
        this.fecha = fecha; // Asigna el valor del parámetro "fecha" al atributo "fecha"
        this.mensaje = mensaje; // Asigna el valor del parámetro "mensaje" al atributo "mensaje"
        this.accion = accion; // Asigna el valor del parámetro "accion" al atributo "accion"
    }
